...
export const sortSelectWrapper = document.getElementById('sort-select-wrapper');
export const sortSelectTrigger = document.getElementById('sort-select-trigger');
export const sortOptions = document.getElementById('sort-options');
export const sortCurrentText = document.getElementById('sort-current-text');
